...
As usual, the next step is to either load some data into R or create some data ourselves. For the exercises within this lab, we will load some data from the file "gradgpa.csv" (which should be inside the "data" folder within your R project).
